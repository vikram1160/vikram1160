        ...
        <div className="col-sm-6 mb-3 mb-sm-0 mb-3">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-text fs-1">Created a youtube clone to imeplement my knowledge in react. Created a youtube clone to imeplement my knowledge in react</p>
        ...
        <div className="col-sm-6 mb-3">
          <div className="card">
            <div className="card-body">
              ...
              <p className="card-text  fs-1">Created a project to avoid mannual work in library. All the work is done through project. It is built using latest technologies. </p>
              <button onClick={working} className="btn btn-danger">Read More..</button>
            </div>
          </div>
        </div>
